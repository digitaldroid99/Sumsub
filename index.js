...
const SUMSUB_APP_TOKEN = 'sbx:TviqWZ39ged4M9pjyOCl4mck.MeI6f7BAZ1qWUxQq6rDI9xoYXCkVjkH0'; // Example: sbx:uY0CgwELmgUAEyl4hNWxLngb.0WSeQeiYny4WEqmAALEAiK2qTC96fBad - Please don't forget to change when switching to production
const SUMSUB_SECRET_KEY = 'ges28mM8LWbeJXTpzXsFKMvTt3kFKKP2'; // Example: Hej2ch71kG2kTd1iIUDZFNsO5C1lh5Gq - Please don't forget to change when switching to production
...
function createApplicant(externalUserId, levelName) {
  ...
  console.log("encoded levelName : ", encodeURIComponent(levelName));
